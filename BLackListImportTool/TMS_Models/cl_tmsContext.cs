...
namespace BLackListImportTool.TMS_Models
{
    public partial class cl_tmsContext : DbContext
    {
        ...
        public virtual DbSet<LocationCarrierReturnConfiguration> LocationCarrierReturnConfigurations { get; set; } = null!;
        ...
        public virtual DbSet<ReturnConfiguration> ReturnConfigurations { get; set; } = null!;
        public virtual DbSet<ReturnDecisionRule> ReturnDecisionRules { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AddressArchive>(entity =>
            {
                entity.HasKey(e => e.AddressId)
                    .HasName("PK__AddressA__091C2AFB9CE7687A");
            ...
            modelBuilder.Entity<CarDriver>(entity =>
            {
                ...
                entity.HasOne(d => d.Driver)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("CarDriver_FK5");
            ...
            modelBuilder.Entity<Consignment>(entity =>
            {
                ...
                entity.Property(e => e.IsStatusTrackManuel).HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<LocationCarrierReturnConfiguration>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("LocationCarrierReturnConfiguration");
                ...
                entity.Property(e => e.LocationCarrierReturnConfigurationId).ValueGeneratedOnAdd();
                ...
                entity.HasOne(d => d.Account)
                    ...
                    .HasForeignKey(d => d.AccountId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("LocationCarrierReturnConfiguration_Account");

                entity.HasOne(d => d.Client)
                    .WithMany()
                    .HasForeignKey(d => d.ClientId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("LocationCarrierReturnConfiguration_Client");

                entity.HasOne(d => d.Location)
                    .WithMany()
                    .HasForeignKey(d => d.LocationId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("LocationCarrierReturnConfiguration_Carrier");
            });
            ...
            modelBuilder.Entity<ReturnConfiguration>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("ReturnConfiguration");

                entity.Property(e => e.ChangedDate).HasColumnType("datetime");

                entity.Property(e => e.CreatedDate).HasColumnType("datetime");

                entity.Property(e => e.ReturnConfigurationId).ValueGeneratedOnAdd();

                entity.Property(e => e.ReturnPageClientLogoUrl)
                    .HasMaxLength(50)
                    .IsUnicode(false);
                ...
                entity.HasOne(d => d.Account)
                    ...
                    .HasForeignKey(d => d.AccountId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ReturnConfiguration_FK");

                entity.HasOne(d => d.Client)
                    .WithMany()
                    .HasForeignKey(d => d.ClientId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ReturnConfiguration_FK_Client");

                entity.HasOne(d => d.DefaultCarrier)
                    .WithMany()
                    .HasForeignKey(d => d.DefaultCarrierId)
                    .HasConstraintName("ReturnConfiguration_FK_Carrier");
            });

            modelBuilder.Entity<ReturnDecisionRule>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("ReturnDecisionRule");
                ...
                entity.Property(e => e.ReturnDecisionRuleId).ValueGeneratedOnAdd();
                ...
                entity.HasOne(d => d.Account)
                    ...
                    .HasForeignKey(d => d.AccountId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ReturnDecisionRule_FK_Account");

                entity.HasOne(d => d.Carrier)
                    .WithMany()
                    .HasForeignKey(d => d.CarrierId)
                    .HasConstraintName("ReturnDecisionRule_FK_Carrier");

                entity.HasOne(d => d.ChangeUserIdentity)
                    .WithMany()
                    .HasForeignKey(d => d.ChangeUserIdentityId)
                    .HasConstraintName("ReturnDecisionRule_FK_UserIdentity");

                entity.HasOne(d => d.City)
                    .WithMany()
                    .HasForeignKey(d => d.CityId)
                    .HasConstraintName("ReturnDecisionRule_FK_City");

                entity.HasOne(d => d.Client)
                    .WithMany()
                    .HasForeignKey(d => d.ClientId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ReturnDecisionRule_FK_Client");

                entity.HasOne(d => d.Country)
                    .WithMany()
                    .HasForeignKey(d => d.CountryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ReturnDecisionRule_FK_Country");

                entity.HasOne(d => d.CreateUserIdentity)
                    .WithMany()
                    .HasForeignKey(d => d.CreateUserIdentityId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ReturnDecisionRule_FK_UserIdentity_CreateUserId");

                entity.HasOne(d => d.Customer)
                    .WithMany()
                    .HasForeignKey(d => d.CustomerId)
                    .HasConstraintName("ReturnDecisionRule_FK_Customer");

                entity.HasOne(d => d.District)
                    .WithMany()
                    .HasForeignKey(d => d.DistrictId)
                    .HasConstraintName("ReturnDecisionRule_FK_District");

                entity.HasOne(d => d.PaymentType)
                    .WithMany()
                    .HasForeignKey(d => d.PaymentTypeId)
                    .HasConstraintName("ReturnDecisionRule_FK_TypeLookup_PaymentId");

                entity.HasOne(d => d.Town)
                    .WithMany()
                    .HasForeignKey(d => d.TownId)
                    .HasConstraintName("ReturnDecisionRule_FK_Town");
            });
            ...
            modelBuilder.Entity<ShipmentArchive>(entity =>
            {
                entity.HasKey(e => e.ShipmentId)
                    .HasName("PK__Shipment__5CAD37ED52043460");
            ...
            modelBuilder.Entity<ShipmentCarrierHistoryArchive>(entity =>
            {
                entity.HasKey(e => e.ShipmentCarrierHistoryId)
                    .HasName("PK__Shipment__CBB1E0B64FA79689");
            ...
            modelBuilder.Entity<ShipmentDeliveryPosition>(entity =>
            {
                ...
                entity.HasOne(d => d.Account)
                    ...
                    .HasForeignKey(d => d.AccountId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ShipmentDeliveryPosition_FK1");
            ...
            modelBuilder.Entity<ShipmentDetailArchive>(entity =>
            {
                entity.HasKey(e => e.ShipmentDetailId)
                    .HasName("PK__Shipment__047143207940E643");
            ...
            modelBuilder.Entity<ShipmentDocumentArchive>(entity =>
            {
                entity.HasKey(e => e.ShipmentDocumentId)
                    .HasName("PK__Shipment__7B0204B53BEB0F6A");
            ...
            modelBuilder.Entity<ShipmentHistoryArchive>(entity =>
            {
                entity.HasKey(e => e.ShipmentHistoryId)
                    .HasName("PK__Shipment__244CDB1D634CFCE9");
            ...
            modelBuilder.Entity<StoreUser>(entity =>
            {
                ...
                entity.Property(e => e.StoreUserId).ValueGeneratedOnAdd();
